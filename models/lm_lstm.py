...
class LM_lstm(ModelLMBase):
    def __init__(self, data, hp):
        ...
        if hp.load_model and os.path.isfile(self.filename):
            ...
            with self.params:
                w_emb = shared_normal((n_tokens, self.n_h), scale=scale*4)
        ...
        def model(x, p, p_dropout):
            ...
            cost, h1, c1, h2, c2 = [0,
                                    batch_col(input_size, p.b1_h), batch_col(input_size, p.b1_c), 
                                    batch_col(input_size, p.b2_h), batch_col(input_size, p.b2_c)]
